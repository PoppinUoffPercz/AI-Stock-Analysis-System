...
class ScionAnalyzer:
    ...
    def run_dcf_model(self, discount_rate=0.10, growth_rate=0.04, terminal_growth=0.02):
        ...
        if fcf is None and not self.cashflow.empty:
            ...
            except Exception:  # noqa: BLE001,S110 - optional statement fallback
                pass
    ...
    def run_net_net_model(self):
        ...
        except Exception as e:  # noqa: BLE001 - provider statement shapes vary; model is optional
    ...
    def generate_full_report(self):
        ...
        except Exception:  # noqa: BLE001,S110 - optional institutional enrichment
            pass
        ...
        output_path = output_root / f"scion_report_{self.symbol}.md"
