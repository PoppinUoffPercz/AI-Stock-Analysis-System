...
class BuffettAnalyzer:
    ...
    def assess_management_quality(self):
        ...
        except Exception:  # noqa: BLE001,S110 - optional treasury-share enrichment
            pass
    ...
    def evaluate_technical_trend(self):
        ...
        except Exception:  # noqa: BLE001 - optional technical-enrichment boundary
            return None
    ...
    def generate_full_report(self):
        ...
        validate_identifier(self.symbol)
        self.fetch_all_data()
        ...
        output_path = output_root / f"buffett_report_{self.symbol}.md"
