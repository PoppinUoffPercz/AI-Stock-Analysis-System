...
from scion_omaha_bots.news_state import load_seen_titles, save_seen_titles
...
class BuffettNewsEngine:
    ...
    def load_seen_state(self):
        self.seen_titles = load_seen_titles(self._state_file)

    def save_seen_state(self):
        save_seen_titles(self._state_file, self.seen_titles)
    ...
    def fetch_news(self, symbol):
        try:
            ...
            return parsed
        except Exception as e:  # noqa: BLE001 - yfinance news-provider boundary
