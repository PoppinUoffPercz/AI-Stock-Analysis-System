...
from scion_omaha_bots.screener import _discovery_tickers
from scion_omaha_bots.smart_money import get_smart_money_score
from scion_omaha_bots.ta_lib import compute_macd, compute_rsi, compute_smas
    ...
    def run_screener(self):
        ...
        for symbol in self.tickers:
            try:
                ...
                except Exception:  # noqa: BLE001 - optional provider-derived smart-money context
                ...
                except Exception:  # noqa: BLE001,S110 - trend enrichment is optional
                    pass
...
if __name__ == "__main__":
    ...
    if results_df.empty:
        ...
        output_path = output_root / "buffett_screener_output.md"
