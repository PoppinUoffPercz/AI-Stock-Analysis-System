...
from scion_omaha_bots.debate import get_debate_score, score_modifier
...
def _get_vix_and_spy():
    ...
    except Exception:  # noqa: BLE001,S110 - optional market context
        pass
    try:
        spy = yf.Ticker("SPY")
...
def generate_daily_brief(tracker=None, prices_dict=None):
    ...
    try:
        ...
        lines.append("")
    except Exception:  # noqa: BLE001,S110 - optional credit context
        pass
