...
def cmd_screener(args):
    ...
    from scion_omaha_bots.notify import ScionNotifier, format_screener_alert
    from scion_omaha_bots.screener import ScionScreener
...
def cmd_analyze(args):
    ...
    from scion_omaha_bots.analyzer import ScionAnalyzer
...
def cmd_news(args):
    ...
    from scion_omaha_bots.news_engine import NewsEngine
    from scion_omaha_bots.notify import ScionNotifier
...
def cmd_log_entry(args):
    ...
    _shared_log_entry(args, bot="scion")
