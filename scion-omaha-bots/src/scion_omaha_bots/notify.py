...
Usage:
  1. As a Python module: `from scion_omaha_bots.notify import ScionNotifier` and call .send_alert()
...
class ScionNotifier:
    ...
    async def send_via_websocket(self, message):
        ...
        try:
            async with websockets.connect(uri) as ws:
                ...
                return True
        except Exception as e:  # noqa: BLE001 - external WebSocket transport boundary
    ...
    def send_via_stdio(self, message):
        ...
        except Exception as e:  # noqa: BLE001 - external subprocess/protocol transport boundary
