...
def get_insider_signal(symbol, ticker=None):
    ...
    except Exception:  # noqa: BLE001 - yfinance insider-data provider boundary
    ...
    if purchases is not None and not purchases.empty:
        ...
        except Exception:  # noqa: BLE001,S110 - optional insider-table normalization
            pass
    ...
    if transactions is not None and not transactions.empty:
        ...
        except Exception:  # noqa: BLE001,S110 - optional transaction detail parsing
            pass
...
def get_institutional_signal(symbol, ticker=None):
    ...
    except Exception:  # noqa: BLE001 - yfinance holder-data provider boundary
        ...
        try:
            ...
            for idx, label in enumerate(major_dict["index"]):
                ...
                if "institutionspercentheld" in label and institutions_pct == 0:
                    institutions_pct = _safe_float(major_dict["data"][idx][0])
        except Exception:  # noqa: BLE001,S110 - optional major-holder normalization
            pass
...
def get_smart_money_summary(symbol):
    ...
    except Exception:  # noqa: BLE001 - public best-effort provider summary boundary
